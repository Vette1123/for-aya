...
const moments: Moment[] = [
  ...
  },
  {
    ...
    month: "يونيو",
    year: "٢٠٢٦",
    title: "يومٌ لهُ طعمٌ خاص",
    text: "ثمّةَ أيّامٌ لا تُشبهُ ما قبلَها. هذا اليومُ منها، حفظتُهُ في القلبِ كما يُحفظُ السرُّ الجميل.",
  },
  {
    date: "02/07/2026",
    dateAr: "٠٢ / ٠٧ / ٢٠٢٦",
    ...
    month: "يوليو",
    year: "٢٠٢٦",
    title: "أغلى ما في التقويم",
    text: "بينَ كلِّ التواريخ، لهذا اليومِ مكانةٌ لا يُدانيها شيء. يومٌ عزيزٌ جدًّا، أحملُهُ كأنّهُ كنزي الذي لا يُقدَّر.",
  },
  {
    date: "?",
    dateAr: "؟",
